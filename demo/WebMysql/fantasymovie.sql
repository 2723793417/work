...
-- ----------------------------
-- Table structure for fantasymovie
-- ----------------------------
DROP TABLE IF EXISTS `fantasymovie`;
CREATE TABLE `fantasymovie`  (
  `mid` int(11) NOT NULL,
...
-- ----------------------------
-- Records of fantasymovie
-- ----------------------------
INSERT INTO `fantasymovie` VALUES (1, '美丽人生', '罗伯托•贝尼尼', '罗伯托•贝尼尼', '啦啦啦', '/Imgs/aq1.png');
