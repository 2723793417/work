...
-- ----------------------------
-- Table structure for annimation
-- ----------------------------
DROP TABLE IF EXISTS `annimation`;
CREATE TABLE `annimation`  (
  `mid` int(11) NOT NULL,
...
-- ----------------------------
-- Records of annimation
-- ----------------------------
INSERT INTO `annimation` VALUES (1, '美丽人生', '罗伯托•贝尼尼', '罗伯托•贝尼尼', '啦啦啦', '/Imgs/aq1.png');
