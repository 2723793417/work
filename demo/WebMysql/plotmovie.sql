...
-- ----------------------------
-- Table structure for plotmovie
-- ----------------------------
DROP TABLE IF EXISTS `plotmovie`;
CREATE TABLE `plotmovie`  (
  `mid` int(11) NOT NULL,
...
-- ----------------------------
-- Records of plotmovie
-- ----------------------------
INSERT INTO `plotmovie` VALUES (1, '美丽人生', '罗伯托•贝尼尼', '罗伯托•贝尼尼', '啦啦啦', '/Imgs/aq1.png');
