...
-- ----------------------------
-- Table structure for activemovie
-- ----------------------------
DROP TABLE IF EXISTS `activemovie`;
...
-- ----------------------------
-- Records of activemovie
-- ----------------------------
INSERT INTO `activemovie` VALUES (1, '美丽人生', '罗伯托•贝尼尼', '罗伯托•贝尼尼', '啦啦啦', '/Imgs/aq1.png');
