...
-- ----------------------------
-- Table structure for lovemovie
-- ----------------------------
DROP TABLE IF EXISTS `lovemovie`;
CREATE TABLE `lovemovie`  (
  `mid` int(11) NOT NULL,
...
-- ----------------------------
-- Records of lovemovie
-- ----------------------------
INSERT INTO `lovemovie` VALUES (1, '美丽人生', '罗伯托•贝尼尼', '罗伯托•贝尼尼', '啦啦啦', '/Imgs/aq1.png');
