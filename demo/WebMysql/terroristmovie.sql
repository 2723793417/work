...
-- ----------------------------
-- Table structure for terroristmovie
-- ----------------------------
DROP TABLE IF EXISTS `terroristmovie`;
CREATE TABLE `terroristmovie`  (
  `mid` int(11) NOT NULL,
...
-- ----------------------------
-- Records of terroristmovie
-- ----------------------------
INSERT INTO `terroristmovie` VALUES (1, '嘟嘟嘟', '罗伯托•贝尼尼', '罗伯托•贝尼尼', '啦啦啦', '/Imgs/aq1.png');
